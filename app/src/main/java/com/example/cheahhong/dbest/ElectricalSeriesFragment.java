...
public class ElectricalSeriesFragment extends Fragment {
    ...
    public ElectricalSeriesFragment() {
        // Required empty public constructor
    }

    public static ElectricalSeriesFragment newInstance(String param1, String param2) {
        ElectricalSeriesFragment fragment = new ElectricalSeriesFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        queryRef = database.getReference("promo").orderByChild("productType").equalTo("electricalseries");
