...
public class PowerToolFragment extends Fragment {
    ...
    public PowerToolFragment() {
        // Required empty public constructor
    }

    public static PowerToolFragment newInstance(String param1, String param2) {
        PowerToolFragment fragment = new PowerToolFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        queryRef = database.getReference("product").child("powertool").orderByChild("latestUpdated");
