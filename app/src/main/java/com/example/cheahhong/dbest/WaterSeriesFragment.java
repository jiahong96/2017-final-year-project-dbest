...
public class WaterSeriesFragment extends Fragment {
    ...
    public WaterSeriesFragment() {
        // Required empty public constructor
    }

    public static WaterSeriesFragment newInstance(String param1, String param2) {
        WaterSeriesFragment fragment = new WaterSeriesFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        queryRef = database.getReference("promo").orderByChild("productType").equalTo("waterseries");
