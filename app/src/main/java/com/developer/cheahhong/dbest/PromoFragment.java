...
public class PromoFragment extends Fragment {
    ...
    Query             queryRef;
    static FirebaseRecyclerAdapter<Product, PromoFragment.ProductViewHolder> adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        queryRef = database.getReference("product").child("promo").orderByChild("latestUpdated");
